...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" {{ Metronic::printAttrs('html') }} {{ Metronic::printClasses('html') }}>
    <head>
        ...
        {{-- Title Section --}}
        <title>{{ config('app.name') }} | @yield('title', $page_title ?? '') - y</title>
                ...
                <div class="widget widget-login bg-transparent animated fadeInUp">
                    ...
                    <div class="widget-body">
                        <div class="login-form mt-lg">
                            ...
                            <div class="form-group">
                                <label for="repassword" class="d-block">Repetir contraseña</label>
                                <div>
                                    <div class="input-group">
                                        <input id="repassword" type="password" required="required" placeholder="tucontraseña" class="form-control border-inputs">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div>
                                    <div class="input-group">
                                        <input id="email" type="email" required="required" placeholder="usuario@dominio.com" class="form-control border-inputs">
                                    </div>
                                </div>
                            </div>
                            <div class="checkbox abc-checkbox mb-4 d-flex form-check">
                                <input id="checkbox1" type="checkbox" class="form-check-input">
                                <label for="checkbox1" class="mr-auto form-check-label">Acepto las condiciones.....</label>
                            </div>
                        </div>
                        <div>
                            <input type="submit" value="Regístrarse" class="btn btn-block btn-primary btn-contact-filmaps">
                        </div>
                        <div class="group">
                            <div class="widget-login-info">
                                <p class="widget-login-info text-center line">O</p>
                                <p class="new-account text-center">Ya tengo una cuenta?</p>
                                <a class="mr-n-lg text-center" href="register.html">Iniciar sesión</a>
                            </div>
                        </div>
                    </div>
                </div>
