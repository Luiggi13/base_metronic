            ...
            <div class="card card-custom gutter-b card-stretch">
                ...
                <div class="card-body">
                    ...
                    <div class="example mb-10">
                        ...
                        <div class="example-preview">
                        <?php echo Metronic::getSVG("media/svg/icons/Clothes/Cap.svg"); ?>
                        <?php echo Metronic::getSVG("media/svg/icons/Communication/Chat-error.svg"); ?>
                        <?php echo Metronic::getSVG("media/svg/icons/Design/Bucket.svg"); ?>
                        <?php echo Metronic::getSVG("media/svg/icons/Design/Substract.svg"); ?>
                        <?php echo Metronic::getSVG("media/svg/icons/Design/Select.svg"); ?>
